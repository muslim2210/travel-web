...
const StatisticCard = ({ value, label }) => {
  return (
    <div className="flex justify-center flex-col sm:w-[350px] sm:h-[160px] md:w-[300px] lg:w-[200px] w-full border border-slate-gray rounded-[32px] px-11 py-10 lg:px-5 lg:py-5">
